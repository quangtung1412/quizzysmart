                        ...
                        {q.options.map((opt: string, optIdx: number) => {
                            ...
                            return (
                                <button
                                    ...
                                    disabled={revealed}
                                    className={`w-full text-left border rounded-lg px-3 sm:px-4 py-3 flex items-center transition text-sm sm:text-base ${correct ? 'border-green-500 bg-green-50' : ''
