    ...
    <div className="space-y-6">
        ...
        <div className="flex space-x-3">
          ...
          {user.role === 'admin' && (
            <button
              ...
              className="px-4 py-2 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg hover:from-purple-700 hover:to-blue-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
              ⚙️ Admin Panel
            </button>
          )}
      ...
      <div className="relative">
        ...
        <input
          ...
          className="block w-full pl-10 pr-3 py-3 border border-slate-300 rounded-xl leading-5 bg-white placeholder-slate-400 focus:outline-none focus:placeholder-slate-600 focus:ring-1 focus:ring-sky-600 focus:border-sky-600"
        />
      </div>
                ...
                <div className="mt-6 space-y-2">
                  ...
                  {test.usedAttempts > 0 && (
                    <button
                      ...
                      className="w-full py-2 px-4 rounded-lg font-medium text-slate-600 bg-slate-100 hover:bg-slate-200 transition-colors border border-slate-200"
                    >
                      📊 Xem chi tiết
                    </button>
                  )}
