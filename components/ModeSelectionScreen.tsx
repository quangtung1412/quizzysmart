...
const ModeSelectionScreen: React.FC<ModeSelectionScreenProps> = ({
  ...
  <div className="grid md:grid-cols-2 gap-8">
        {/* Practice Mode */}
        <div className="bg-gradient-to-br from-green-50 to-emerald-100 p-8 rounded-2xl shadow-lg border border-green-200 hover:shadow-xl transition-all duration-300 cursor-pointer group"
             onClick={onSelectPracticeMode}>
          <div className="flex flex-col items-center space-y-6">
            <div className="w-20 h-20 bg-green-500 rounded-full flex items-center justify-center text-white text-3xl group-hover:scale-110 transition-transform duration-300">
            ...
            <div>
              <h3 className="text-2xl font-bold text-green-700 mb-3">Ôn luyện</h3>
            ...
            <button className="bg-green-500 hover:bg-green-600 text-white font-semibold py-3 px-8 rounded-xl transition-colors duration-200 group-hover:bg-green-600">
              Bắt đầu ôn luyện
            </button>
          </div>
        </div>
        ...
        {/* Test Mode */}
        <div className="bg-gradient-to-br from-blue-50 to-sky-100 p-8 rounded-2xl shadow-lg border border-blue-200 hover:shadow-xl transition-all duration-300 cursor-pointer group"
             onClick={onSelectTestMode}>
          <div className="flex flex-col items-center space-y-6">
            <div className="w-20 h-20 bg-blue-500 rounded-full flex items-center justify-center text-white text-3xl group-hover:scale-110 transition-transform duration-300">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-10 h-10">
            ...
            <div>
              <h3 className="text-2xl font-bold text-blue-700 mb-3">Thi</h3>
            ...
            <button className="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-3 px-8 rounded-xl transition-colors duration-200 group-hover:bg-blue-600">
              Vào thi
            </button>
          </div>
        </div>
